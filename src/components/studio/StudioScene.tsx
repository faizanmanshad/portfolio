...
export default function StudioScene({ records }: { records:Records }) {
 ...
 {(!ready||failed)&&<div className="model-loading"><img src="/portfolio/images/studio-fallback.svg" alt="Architectural drawing of a pavilion with a truss bridge"/><span>{failed?'The studio, in drawing form. Explore the work below.':'Setting out the studio…'}</span></div>}
 </div>
